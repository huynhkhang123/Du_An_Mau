package com.edusys.notification;
...
public class Notification extends javax.swing.JComponent {
    ...
    public Notification(Dialog d, Type type, Location location, String message) {
        this.d = d;
        this.type = type;
            ...
            public void begin() {
                if (!showing) {
                    ...
                    if (location == Location.TOP_CENTER) {
                        x = d.getX() + ((d.getWidth() - dialog.getWidth()) / 2);
                        y = d.getY();
                        top_to_bot = true;
