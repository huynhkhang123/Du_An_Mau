...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/com/edusys/textfield/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/edusys/textfield/eye_hide.png")).getImage();
    ...
    public void showing(boolean action) {
